...
To start using the infrastructure, you need a license key, which can be obtained once you have paid for a plan. If you have not made a prior payment, please refer to the pricing section.

<Card title="Pricing" icon="money-bill" iconType="regular" horizontal href="https://www.reachsdk.online/pricing">
